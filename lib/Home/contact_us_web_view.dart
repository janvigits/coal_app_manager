...
class ContactUsWebViewExample extends StatefulWidget {
  String webURL = "";
  ContactUsWebViewExample({required this.webURL});
  @override
  WebViewExampleState createState() => WebViewExampleState();
}

class WebViewExampleState extends State<ContactUsWebViewExample> {
